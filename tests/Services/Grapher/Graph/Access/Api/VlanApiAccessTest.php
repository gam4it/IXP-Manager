 ...
 */
class VlanApiAccessTest extends Access
{
    ...
    public function testApiPublicAccess()
    {
        ...
        $response = $this->get('/grapher/vlan?id=1');
    ...
    public function testWebCustUserAccess()
    {
        ...
        $response = $this->actingAs( $this->getCustUser() )->get('/grapher/vlan?id=1');
        $response->assertStatus(200);

        $response = $this->actingAs( $this->getCustAdminUser() )->get('/grapher/vlan?id=1');
        $response->assertStatus(200);

        $response = $this->actingAs( $this->getSuperUser() )->get('/grapher/vlan?id=1');
        $response->assertStatus(200);
    }
